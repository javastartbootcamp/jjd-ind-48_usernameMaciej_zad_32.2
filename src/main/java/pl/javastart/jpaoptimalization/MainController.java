...
public class MainController {
    ...
    public String countryWithBiggestCity(Model model) {
        List<Country> countries = countryService.findAllCountriesWithBiggestCity();
    ...
    public String countryWithLanguages(Model model) {
        List<Country> countries = countryService.findAllCountriesWithLanguages();
    ...
    public String languagesWithCountries(Model model) {
        List<CountryLanguage> languages = countryLanguageService.findAllCountriesWithLanguages();
